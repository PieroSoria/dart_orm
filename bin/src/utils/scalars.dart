...
final _scalars = <String, Reference>{
  ...
  'Decimal': refer('Decimal', 'package:dart_orm/dart_orm.dart'),
  'Null': refer('PrismaNull', 'package:dart_orm/dart_orm.dart'),
  'Json': refer('PrismaJson', 'package:dart_orm/dart_orm.dart'),
};
