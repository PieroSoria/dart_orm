...
class GeneratorManifest implements JsonConvertible<Map<String, dynamic>> {
  ...
  const GeneratorManifest({this.prettyName, this.defaultOutput, this.denylists, this.requiresGenerators, this.requiresEngines, this.requiresEngineVersion, this.version});
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (requiresEngineVersion != null) 'requiresEngineVersion': requiresEngineVersion,
      if (version != null) 'version': version,
    };
  }
}

class GeneratorManifestDenyList implements JsonConvertible<Map<String, dynamic>> {
  ...
  factory GeneratorManifestDenyList.fromJson(Map<String, dynamic> json) {
    return GeneratorManifestDenyList(models: json['models']?.cast<String>(), fields: json['fields']?.cast<String>());
  }

  @override
  Map<String, dynamic> toJson() {
    return {if (models != null) 'models': models, if (fields != null) 'fields': fields};
  }
}
