...
String validateDatasourceURL(String datasourceUrl) {
  ...
  final databasePath = path.relative(path.join(pwd, datasourceUrl.substring(5)));
  if (File(databasePath).existsSync()) {
    return 'file:$databasePath';
  }

  throw PrismaClientInitializationError(errorCode: "P1003", message: "The SQLite database file ($databasePath) does not exist");
}
