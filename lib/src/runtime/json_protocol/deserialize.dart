...
dynamic _deserializeJsonObject(Map object) {
  ...
  return object.map((key, value) => MapEntry(key, deserializeJsonResponse(value)));
}
...
dynamic _deserializeTaggedValue(Map object) => switch (object) {
      ...
      {r'$type': 'DateTime', 'value': final String value} => DateTime.parse(value),
      {r'$type': 'Decimal', 'value': final String value} => Decimal.parse(value),
